    ...
    render() {
        return <div className="w-fit">
            <div className="shadow-2xl rounded-2xl bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-70">
                <div className="sm:pl-1 sm:pr-1 lg:pr-4 2xl:pr-6 font-light leading-normal text-green-600 sm:text-base md:text-xl lg:text-2xl xl:text-4xl 2xl:text-5xl 8xl:text-6xl">
                    {this.props.title}
                </div>
                <div className="sm:pl-1 2xl:pr-5 font-light leading-normal text-green-600 sm:text-sm lg:text-base xl:text-xl 2xl:text-2xl 8xl:text-3xl">
                    {this.props.subTitle}
                </div>
