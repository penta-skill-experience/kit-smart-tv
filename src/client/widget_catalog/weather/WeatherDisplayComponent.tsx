        ...
        return (this.state.gotIcon ? <div className="grid grid-col-3 grid-flow-col gap-3 box-border items-center h-fit">
                ...
                <div className="grid grid-rows-3 sm:gap-0 xl:gap-1">
                    <div className="font-light leading-normal sm:text-xs xl:text-base 2xl:text-xl 4xl:text-2xl 8xl:text-3xl sm:text-left">
                        Precipitation: <span className="font-medium sm:text-xs xl:text-lg 2xl:text-2xl 4xl:text-3xl 8xl:text-5xl sm:text-left">{this.state.precipitation}</span>%
                    </div>
                    <div className="font-light leading-normal sm:text-xs xl:text-base 2xl:text-xl 4xl:text-2xl 8xl:text-3xl sm:text-left">
                        Humidity: <span className="font-medium sm:text-xs xl:text-lg 2xl:text-2xl 4xl:text-3xl 8xl:text-5xl sm:text-left">{this.state.humidity}</span>%
                    </div>
                    <div
                        className="font-light leading-normal sm:text-xs xl:text-base 2xl:text-xl 4xl:text-2xl 8xl:text-3xl sm:text-left">
                        Wind: <span className="font-medium sm:text-xs xl:text-lg 2xl:text-2xl 4xl:text-3xl 8xl:text-5xl sm:text-left">{this.state.windSpeed}</span> km/h
                    </div>
                </div>
        </div>:<div/>);
    }
