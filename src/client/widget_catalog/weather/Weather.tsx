...
export class Weather extends React.Component<any, any> {
    ...
    render() {
        return <div className="grid grid-col-3 grid-flow-col gap-3 box-border items-center sm:pt-4 xl:pt-12 2xl:pt-16 8xl:pt-20">
                ...
                <div className="justify-center">
                    <div className="font-light leading-normal text-white sm:text-base xl:text-xl 2xl:text-3xl 4xl:text-4xl 8xl:text-6xl">
                        {kelvinToCelsiusRounded(this.state.temp)}°
                    </div>
                    <div className="font-light leading-normal text-white sm:text-xs xl:text-base 2xl:text-xl 4xl:text-2xl 8xl:text-3xl">
                        Karlsruhe
                    </div>
                </div>
                <div className="grid grid-rows-3 sm:gap-0 xl:gap-1">
                    <div className="font-light leading-normal text-white sm:text-xs xl:text-base 2xl:text-xl 4xl:text-2xl 8xl:text-3xl sm:text-left">
                    ...
                    <div
                        className="font-light leading-normal text-white sm:text-xs xl:text-base 2xl:text-xl 4xl:text-2xl 8xl:text-3xl sm:text-left">
