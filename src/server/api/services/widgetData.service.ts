...
export async function createWidgetData(input: DocumentDefinition<WidgetDataData>) {
    //before creating a widget data list, delete all widget data list in the collection top guarantee there is only one stored at a time
    //delete all
    await WidgetDataModel.deleteMany();
